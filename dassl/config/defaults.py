...
_C.INPUT.FRAMES = 8
_C.INPUT.CLIP_PREPROCESS = False
_C.INPUT.TASK = "video"
_C.INPUT.TYPE = "tensor"
...
_C.INPUT.WHOLE_FRAMES = 64
_C.INPUT.EXPAND_TRAIN = (256, 340)
_C.INPUT.EXPAND_TEST = (256, 340)
...
_C.MODEL.EVO = CN()
_C.MODEL.EVO.ENABLE = True
_C.MODEL.EVO.ENC_OUT_DIM = 768
_C.MODEL.EVO.DEC_TYPE = "S_T"
_C.MODEL.EVO.ENC_NAME = "encoder"
_C.MODEL.EVO.ACT = "gelu"
_C.MODEL.EVO.BIAS = False
_C.MODEL.EVO.PROMPT_AGGREGATION = "mul"
_C.MODEL.EVO.PROMPT_INIT = "random"
_C.MODEL.EVO.SPATIAL_IR = True
_C.MODEL.EVO.LOSS = "Cross_Entropy"
_C.MODEL.EVO.LAMBDA = 0.0
# Definition of COOP
_C.MODEL.COOP = CN()
_C.MODEL.COOP.ENABLE = False
_C.MODEL.COOP.TEXT_LINEAR = False
# Definition of backbone
_C.MODEL.BACKBONE = CN()
# Definition of image backbone
_C.MODEL.BACKBONE.IMAGE = CN()
_C.MODEL.BACKBONE.IMAGE.NAME = ""
_C.MODEL.BACKBONE.IMAGE.PRETRAINED = True
# Definition of video backbone
_C.MODEL.BACKBONE.VIDEO = CN()
_C.MODEL.BACKBONE.VIDEO.NAME = ""
_C.MODEL.BACKBONE.VIDEO.PRETRAINED = True
# Methods of temporal aggrgation
_C.MODEL.TEMPORAL = "mean_pool"
