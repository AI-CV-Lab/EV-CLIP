...
class SimpleTrainer(TrainerBase):
    ...
    def after_epoch(self):
        ...
        meet_validation_freq = (
            ((self.epoch + 1) % self.cfg.TRAIN.VALIDATION_FREQ == 0) # and (self.epoch > 99)
            if (self.cfg.TRAIN.VALIDATION_FREQ > 0) else False
        )

        if do_test and meet_validation_freq and self.cfg.TEST.FINAL_MODEL == "best_val":
