...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--keyword", action="append", default=["verb accuracy", "noun accuracy", "action accuracy", "action error"], help="which keyword to extract"
    )
    ...
    if 'hmdb51' in args.directory:
        args.keyword = ["accuracy", "error"]
